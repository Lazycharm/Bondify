  ...
  theme: {
  	extend: {
  		...
  		keyframes: {
            ...
            'float-up': { '0%': { transform: 'translateY(100vh) scale(0)', opacity: '0' }, '10%': { opacity: '1' }, '100%': { transform: 'translateY(-10vh) scale(0.5)', opacity: '0' } }
  		},
  		animation: {
  			'accordion-down': 'accordion-down 0.2s ease-out',
  			'accordion-up': 'accordion-up 0.2s ease-out',
            'float-up': 'float-up 4s ease-in forwards'
  		}
  	}
  },
